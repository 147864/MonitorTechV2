...
class TipoVeiculosController extends Controller
{
    ...
    { //request encapsula os campos recebidos do formulário para enviar para o banco
    ...
    /*
    public function getPadraoBateria(TipoVeiculoRequest $request ){
        $novo_tipoVeiculos = $request->all();

        $comparaBat = $request->bateria;
        $comparaAlt = $request->alternador;
